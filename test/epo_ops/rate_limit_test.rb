...
module Epo
  class RateLimitTest < Minitest::Test
    ...
    def test_limit_reached_is_true_if_header_x_rejection_reason_is_set
      limit = EpoOps::RateLimit.new('x-rejection-reason' => 'empty')
    ...
    def test_return_the_right_rejection_reason
      limit = EpoOps::RateLimit.new('x-rejection-reason' => 'RegisteredQuotaPerWeek')
      assert_equal :weekly_quota, limit.rejection_reason

      limit = EpoOps::RateLimit.new('x-rejection-reason' => 'IndividualQuotaPerHour')
    ...
    def test_return_the_hourly_quota_if_it_is_set
      limit = EpoOps::RateLimit.new('x-individualquotaperhour-used' => '12345')
    ...
    def test_return_the_weekly_quota_if_it_is_set
      limit = EpoOps::RateLimit.new('x-registeredquotaperweek-used' => '12345')
    ...
    def test_return_1_minute_from_now_if_the_reason_is_unknown
      limit = EpoOps::RateLimit.new('x-rejection-reason' => 'Foobar')
